...
%define kmod_install_path	extra/kmod-redhat-qede
...
# Source code patches
Patch0:	0000-add-qed-Module-symvers.patch
Patch1:	0001-revert-netdrv-qede-Use-NETIF_F_GRO_HW.patch
Patch2:	0002-version-bump.patch
Patch3:	0003-net-next-1-2-qed-Add-driver-support-for-20G-link-speed.patch
Patch4:	0004-net-next-2-2-qede-Add-driver-support-for-20G-link-speed.patch
...
rpm -ql kmod-redhat-qede-%{kmod_driver_version}-%{kmod_rpm_release}%{?dist}.$(arch) | \
